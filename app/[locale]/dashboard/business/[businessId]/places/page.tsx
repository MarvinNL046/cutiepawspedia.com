...
export default async function PlacesPage({ params }: PlacesPageProps) {
  ...
  const labels = {
    ...
    fr: {
      ...
      description: "Gérez vos établissements",
      noPlaces: "Pas encore d'établissement",
      noPlacesDesc: "Aucun établissement n'est encore lié à cette entreprise. Réclamez une annonce pour commencer !",
      claimListing: "Rechercher & Réclamer une Annonce",
      name: "Nom",
      ...
      upgradeToAdd: "Passer à une offre supérieure",
      locationLimit: `Vous avez atteint la limite de ${maxLocations} établissement pour votre plan ${planKey}`,
      unlimitedLocations: "Ajoutez des établissements illimités avec ELITE",
    },
  };
