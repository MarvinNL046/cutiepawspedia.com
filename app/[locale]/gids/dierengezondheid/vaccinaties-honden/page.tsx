      ...
      <article className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link href="/nl/gids/dierengezondheid/vaccinaties-katten" className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-5 hover:border-cpCoral/40 transition-all group">
