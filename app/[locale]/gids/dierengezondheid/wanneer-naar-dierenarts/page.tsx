      ...
      <article className="container mx-auto max-w-4xl px-4 py-12">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 bg-white dark:bg-cpCharcoal/50 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground dark:text-cpCream/70">Extreem hijgen, temperature meer dan 40°C, braken, bewustzijnsverlies</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-6">
              <div className="flex items-start gap-3 mb-3">
                <span className="flex-shrink-0 w-8 h-8 rounded-full bg-cpCoral text-white flex items-center justify-center font-bold">
                  meer dan 1
                </span>
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-foreground dark:text-cpCream mb-2">Weigeren van Eten en Drinken (meer dan 24 uur)</h3>
                  ...
                  <div className="bg-cpCoral/10 dark:bg-cpCoral/5 rounded-lg p-3">
                    <p className="text-xs text-foreground dark:text-cpCream"><strong>Let op:</strong> Katten die meer dan 48 uur niet eten lopen risico op leververvetting</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground dark:text-cpCream/70 mb-3">
                    Eén keer braken is vaak onschuldig, maar bij herhaaldelijk braken (meer dan 3x), diarree met bloed, of beide samen: bel je dierenarts.
                  </p>
                  <div className="bg-cpCoral/10 dark:bg-cpCoral/5 rounded-lg p-3">
            ...
            <div className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground dark:text-cpCream/70 mb-3">
                    Aanhoudend hoesten (meer dan 2 dagen), hijgen zonder aanleiding, neusvloed, of ademhaling met moeite.
                  </p>
                  <div className="bg-cpCoral/10 dark:bg-cpCoral/5 rounded-lg p-3">
            ...
            <div className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground dark:text-cpCream/70 mb-3">
                    Onverklaard gewichtsverlies (meer dan 10% in 1 maand) of plotselinge toename kan duiden op schildklier-, nier- of leverproblematiek.
                  </p>
                  <div className="bg-cpCoral/10 dark:bg-cpCoral/5 rounded-lg p-3">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link href="/nl/gids/dierengezondheid/vaccinaties-honden" className="bg-card dark:bg-cpSurface/50 rounded-xl border border-border dark:border-cpAmber/20 p-5 hover:border-cpCoral/40 transition-all group">
