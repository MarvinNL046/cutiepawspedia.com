      ...
      <article className="container mx-auto max-w-4xl px-4 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground dark:text-cpCream/80 leading-relaxed">
              Mentale stimulatie is ook belangrijk. <Link href="/nl/netherlands" className="text-cpCoral hover:underline">Zoekspelletjes en puzzelspeelgoed</Link> kunnen je senior hond mentaal actief houden zonder fysieke belasting.
            </p>
          </section>
