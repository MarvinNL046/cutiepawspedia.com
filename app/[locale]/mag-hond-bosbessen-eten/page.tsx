/**
 * Safe Food Page: Bosbessen - Honden (Dogs)
 * Type: Veilig voedsel
...
export const metadata: Metadata = {
  title: "Mag een Hond Bosbessen Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen bosbessen eten. Bosbessen zijn rijk aan antioxidanten en veilig voor honden in kleine hoeveelheden.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Bosbessen Eten? | Veilig Voedsel",
    description: "Ja, honden mogen bosbessen eten. Bosbessen zijn rijk aan antioxidanten en veilig voor honden.",
    type: "article",
  },
};

export default function MagHondBosbessenEten() {
  return (
      ...
      <section className="bg-gradient-to-b from-emerald-50 via-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent border-b border-border dark:border-emerald-800/30">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <FoodGuideBreadcrumb
            ...
            currentPage="Bosbessen voor Honden"
          />
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, bosbessen zijn veilig voor honden
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Bosbessen zijn een gezonde snack voor honden, vol antioxidanten en vitamines. Geef ze met mate als traktatie.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Bosbessen voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Rijk aan antioxidanten</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Helpen vrije radicalen te bestrijden en ondersteunen het immuunsysteem.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamines C en K</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunen de gezondheid van botten en bloedstolling.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Laag in calorieën</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ideale snack voor honden die op dieet zijn of overgewicht hebben.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vezels voor spijsvertering</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunen een gezonde darmwerking.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Bosbessen
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Was de bosbessen grondig voordat je ze geeft</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geef verse of ingevroren bosbessen (geen gesuikerde)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Begin met een paar bosbessen om te testen of je hond ze verdraagt</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel bosbessen veilig zijn, zijn bepaalde vruchten levensgevaarlijk voor honden.
                Weet je welke vruchten je hond absoluut NIET mag eten?
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <Link href="/nl/is-avocado-giftig-voor-honden" className="inline-flex items-center gap-1 bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 px-3 py-1.5 rounded-full text-sm font-medium hover:bg-red-200 dark:hover:bg-red-900/60 transition-colors">
                  Avocado
                </Link>
                ...
                <Link href="/nl/is-macadamia-noten-giftig-voor-honden" className="inline-flex items-center gap-1 bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 px-3 py-1.5 rounded-full text-sm font-medium hover:bg-red-200 dark:hover:bg-red-900/60 transition-colors">
                  Macadamia noten
                </Link>
              </div>
            </div>
