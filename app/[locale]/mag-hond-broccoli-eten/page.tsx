/**
 * Safe Food Page: Broccoli - Honden (Dogs)
...
export const metadata: Metadata = {
  title: "Mag een Hond Broccoli Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen broccoli eten in kleine hoeveelheden. Gekookte broccoli is veilig, maar geef het met mate vanwege mogelijke maagklachten.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Broccoli Eten? | Veilig Voedsel",
    description: "Ja, honden mogen broccoli eten in kleine hoeveelheden. Gekookte broccoli is veilig met mate.",
    type: "article",
  },
};

export default function MagHondBroccoliEten() {
  return (
      ...
      <section className="bg-gradient-to-b from-emerald-50 via-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent border-b border-border dark:border-emerald-800/30">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <FoodGuideBreadcrumb
            ...
            currentPage="Broccoli voor Honden"
          />
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, broccoli is veilig in kleine hoeveelheden
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Gekookte broccoli is veilig voor honden als je het in kleine porties geeft. Te veel broccoli kan maagklachten veroorzaken.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Broccoli voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Rijk aan vitamine C</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunt het immuunsysteem en is een krachtige antioxidant.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vezels voor spijsvertering</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Helpt bij een gezonde spijsvertering en regelmatige ontlasting.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Weinig calorieën</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ideaal als gezonde snack zonder veel calorieën.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Bevat vitamine K</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Belangrijk voor sterke botten en bloedstolling.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Broccoli
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Stoom of kook de broccoli zonder zout of kruiden</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geef alleen kleine hoeveelheden (max 10% van dagelijkse voeding)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Snijd in kleine stukjes om verslikken te voorkomen</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Begin met een kleine portie om de reactie te testen</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel broccoli veilig is in kleine hoeveelheden, zijn sommige voedingsmiddelen levensgevaarlijk voor honden.
