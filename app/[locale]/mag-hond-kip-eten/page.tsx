/**
 * Safe Food Page: Kip - Honden (Dogs)
 * Type: Veilig voedsel
...
export const metadata: Metadata = {
  title: "Mag een Hond Kip Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen gekookte kip eten. Kip is veilig en een uitstekende eiwitbron voor honden. Lees meer over de voordelen en tips.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Kip Eten? | Veilig Voedsel",
    description: "Ja, honden mogen gekookte kip eten. Kip is veilig en een uitstekende eiwitbron voor honden.",
    type: "article",
  },
};

export default function MagHondKipEten() {
  return (
        ...
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, gekookte kip is veilig voor honden
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Gekookte kip is een uitstekende eiwitbron en wordt vaak aanbevolen door dierenartsen als onderdeel van een gezond dieet.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Kip voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Hoogwaardige eiwitten</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Kip bevat alle essentiële aminozuren die honden nodig hebben.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Makkelijk verteerbaar</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ideaal bij maagklachten of als onderdeel van een bland dieet.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Laag in vet</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Kipfilet zonder vel is een mager en gezond vleessoort.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamines & mineralen</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Bevat vitamine B6, niacine en fosfor.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Kip
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Kook de kip altijd goed door - nooit rauw voeren</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Verwijder alle botjes - deze kunnen verslikking veroorzaken</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Gebruik geen zout, kruiden of ui/knoflook bij bereiding</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Combineer met rijst voor een compleet bland dieet</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel kip veilig is, zijn er veel voedingsmiddelen die gevaarlijk zijn voor honden.
