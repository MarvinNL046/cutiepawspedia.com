/**
 * Safe Food Page: Pompoen - Honden (Dogs)
 * Type: Veilig voedsel
...
export const metadata: Metadata = {
  title: "Mag een Hond Pompoen Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen pompoen eten. Pompoen is veilig, voedzaam en uitstekend voor de spijsvertering van je hond.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Pompoen Eten? | Veilig Voedsel",
    description: "Ja, honden mogen pompoen eten. Pompoen is veilig en uitstekend voor de spijsvertering.",
    type: "article",
  },
};

export default function MagHondPompoenEten() {
  return (
      ...
      <section className="bg-gradient-to-b from-emerald-50 via-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent border-b border-border dark:border-emerald-800/30">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <FoodGuideBreadcrumb
            ...
            currentPage="Pompoen voor Honden"
          />
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, gekookte pompoen is uitstekend voor honden
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Pompoen is een gezonde en veilige snack voor honden, vol vezels en vitamine A. Zorg ervoor dat het gekookt en puur is, zonder kruiden of suiker.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Pompoen voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Rijk aan vezels</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Helpt de spijsvertering en kan zowel diarree als verstopping verlichten.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamine A</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunt gezonde ogen, huid en vacht van je hond.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Laag in calorieën</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ideaal voor honden die op dieet zijn of een gezond gewicht moeten behouden.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Mineralen en antioxidanten</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Bevat kalium en antioxidanten die het immuunsysteem ondersteunen.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Pompoen
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Gebruik alleen gekookte, pure pompoen zonder kruiden of specerijen</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geen pompoen uit blik met taartmix (bevat suiker en kruiden)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Begin met kleine hoeveelheden (1-2 eetlepels voor kleine honden)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Max 10% van dagelijkse calorie-inname als supplement</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel pompoen veilig is, zijn bepaalde voedingsmiddelen levensgevaarlijk voor honden.
                Weet je welke zoetstoffen je hond absoluut NIET mag hebben?
              </p>
