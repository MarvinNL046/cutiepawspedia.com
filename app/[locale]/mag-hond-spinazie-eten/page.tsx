/**
 * Safe Food Page: Spinazie - Honden (Dogs)
...
export const metadata: Metadata = {
  title: "Mag een Hond Spinazie Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen spinazie eten in kleine hoeveelheden. Gekookte spinazie is veilig, maar geef het met mate vanwege oxaalzuur.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Spinazie Eten? | Veilig Voedsel",
    description: "Ja, honden mogen spinazie eten in kleine hoeveelheden. Gekookte spinazie is veilig met mate.",
    type: "article",
  },
};

export default function MagHondSpinazieEten() {
  return (
      ...
      <section className="bg-gradient-to-b from-emerald-50 via-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent border-b border-border dark:border-emerald-800/30">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <FoodGuideBreadcrumb
            ...
            currentPage="Spinazie voor Honden"
          />
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, spinazie is veilig met mate
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Gekookte spinazie is veilig voor honden als je het in kleine porties geeft. Vanwege oxaalzuur is matige consumptie belangrijk.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Spinazie voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Rijk aan ijzer</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunt de productie van rode bloedcellen en energie.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vol antioxidanten</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Helpt bij het beschermen van cellen tegen schade.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamine A en K</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Belangrijk voor ogen, huid en bloedstolling.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vezels en water</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Helpt bij gezonde spijsvertering en hydratatie.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                ...
                <span className="text-foreground dark:text-cpCream">Stoom of kook de spinazie zonder zout, ui of knoflook</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geef alleen kleine hoeveelheden als incidentele traktatie</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Fijnhakken maakt het makkelijker verteerbaar</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Vermijd spinazie bij honden met nierproblemen</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel spinazie veilig is met mate, zijn sommige voedingsmiddelen levensgevaarlijk voor honden.
