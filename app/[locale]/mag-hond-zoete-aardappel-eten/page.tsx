/**
 * Safe Food Page: Zoete Aardappel - Honden (Dogs)
 * Type: Veilig voedsel
...
export const metadata: Metadata = {
  title: "Mag een Hond Zoete Aardappel Eten? | Veilig Voedsel voor Honden",
  description: "Ja, honden mogen gekookte zoete aardappel eten. Zoete aardappel is voedzaam, rijk aan vezels en vitamines, en veilig voor honden.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Hond Zoete Aardappel Eten? | Veilig Voedsel",
    description: "Ja, honden mogen gekookte zoete aardappel eten. Voedzaam en veilig voor honden.",
    type: "article",
  },
};

export default function MagHondZoeteAardappelEten() {
  return (
      ...
      <section className="bg-gradient-to-b from-emerald-50 via-emerald-50/50 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent border-b border-border dark:border-emerald-800/30">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          <FoodGuideBreadcrumb
            ...
            currentPage="Zoete Aardappel voor Honden"
          />
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground dark:text-cpCream mb-6">
            Mag een Hond Zoete Aardappel Eten?
          </h1>
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, maar alleen gekookt (nooit rauw)
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Gekookte zoete aardappel is een gezonde en veilige snack voor honden, vol vezels en vitamines. Geef nooit rauwe zoete aardappel, deze is moeilijk verteerbaar.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Zoete Aardappel voor Honden
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Rijk aan vezels</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunt een gezonde spijsvertering en regelmatige ontlasting.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamine A en bèta-caroteen</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Bevordert gezonde ogen, huid en immuunsysteem.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamine C en B6</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunen het immuunsysteem en de gezondheid van het zenuwstelsel.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Mangaan en kalium</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Essentiële mineralen voor botten en spieren.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Zoete Aardappel
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Altijd koken - nooit rauw geven (rauwe zoete aardappel is moeilijk verteerbaar)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geen kruiden, zout, boter of suiker toevoegen</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Schil verwijderen of goed schoonmaken</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Kleine hoeveelheden geven (max 10% van dagelijkse calorie-inname)</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel zoete aardappel veilig is, zijn bepaalde groenten levensgevaarlijk voor honden.
                Weet je welke groenten je hond absoluut NIET mag eten?
              </p>
