...
export const metadata: Metadata = {
  title: "Mag een Kat Ei Eten? | Veilig Voedsel voor Katten",
  description: "Ja, katten mogen gekookt ei eten. Gekookt ei is veilig en voedzaam voor katten. Lees meer over de voordelen en tips voor het voeren van ei.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  openGraph: {
    title: "Mag een Kat Ei Eten? | Veilig Voedsel",
    description: "Ja, katten mogen gekookt ei eten. Gekookt ei is veilig en voedzaam voor katten.",
    type: "article",
  },
};

export default function MagKatEiEten() {
  return (
        ...
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/40 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
            <h2 className="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-2">
              Ja, gekookt ei is veilig en voedzaam voor katten
            </h2>
            <p className="text-emerald-700 dark:text-emerald-300">
              Eieren zijn een uitstekende bron van compleet eiwit voor katten. Zorg ervoor dat het ei altijd gekookt is, nooit rauw.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Voordelen van Ei voor Katten
            </h2>

            <div className="grid md:grid-cols-2 gap-4 not-prose">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Compleet eiwit</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Bevat alle essentiële aminozuren die katten nodig hebben voor spieropbouw.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Vitamines A en B12</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Ondersteunen gezond zicht, immuunsysteem en zenuwfunctie.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">Gezonde vacht</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Bevat biotine en taurine die bijdragen aan een glanzende vacht.</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                <h3 className="font-semibold text-foreground dark:text-cpCream mb-2">IJzer en selenium</h3>
                <p className="text-sm text-muted-foreground dark:text-cpCream/70">Belangrijke mineralen voor energieproductie en antioxidanten.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground dark:text-cpCream mb-6 flex items-center gap-2">
              ...
              Tips voor het Voeren van Ei
            </h2>

            <ul className="space-y-3 not-prose">
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Kook het ei altijd goed door (rauw eiwit bevat avidine dat biotine-opname blokkeert)</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Gebruik geen zout, kruiden of andere smaakmakers</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Geef ei als traktatie of supplement, niet als hoofdvoedsel</span>
              </li>
              <li className="flex items-start gap-3 bg-card dark:bg-cpSurface/50 rounded-lg p-4">
                <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-foreground dark:text-cpCream">Begin met kleine hoeveelheden (1-2 theelepels) om te testen</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-300 dark:border-amber-700">
              ...
              <p className="text-amber-700 dark:text-amber-300 mb-4">
                Hoewel ei veilig is, zijn bepaalde voedingsmiddelen levensgevaarlijk voor katten.
