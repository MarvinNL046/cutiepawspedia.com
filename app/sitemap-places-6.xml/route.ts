/**
 * Places Sitemap Page 6 Route (/sitemap-places-6.xml)
 *
 * Page 6 of paginated places sitemap.
 * Returns empty sitemap if page 6 not needed yet.
 */
...
export async function GET() {
  try {
    ...
    console.error("Error generating places sitemap page 6:", error);
    return new NextResponse(
      `<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"></urlset>`,
      { status: 200, headers: { "Content-Type": "application/xml" } }
    );
