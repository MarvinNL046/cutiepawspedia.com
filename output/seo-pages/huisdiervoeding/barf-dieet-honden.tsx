              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground dark:text-cpCream/80">
                    ...
                    <Link href="/nl/seo/huisdiervoeding/huisdier-afvallen" className="text-cpCoral hover:underline">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-600 dark:text-red-400">
                    ...
                    <Link href="/nl/seo/huisdiervoeding/giftig-voedsel-honden-katten" className="underline">
