      ...
      <article className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-muted-foreground dark:text-cpCream/70 mb-4">
            ...
            <Link href="/nl/seo/huisdiervoeding/kattenvoer-nat-vs-droog" className="text-cpCoral hover:underline">
              nat versus droog voer
            </Link>
            {" "}en{" "}
            <Link href="/nl/seo/huisdiervoeding/barf-dieet-honden" className="text-cpCoral hover:underline">
